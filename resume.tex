...
\section{Projects}
  \resumeSubHeadingListStart
  \resumeSubItem{\textbf{Code Loom (2023)}}
    \begin{flushleft}
    A website that uses OpenAI's generative capabilities to generate clear and comprehensive code documentation across various programming languages. Link: {\underline{\href{https://code-loom.com}{https://code-loom.com}}
    \end{flushleft}
    ...
    \begin{flushleft}
      ...
      \end{flushleft}
    \resumeSubItem{\textbf{Tiny Kings (2022)}}
    \begin{flushleft}
