  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        {Demonstrated ability to build websites from start to finish, seamlessly integrating OpenAI's generative features and utilizing Node.js. Exemplified these skills in the Code-Loom project.}
      \resumeItemListEnd
...
\section{Projects}
  \resumeSubHeadingListStart
  \resumeSubItem{\href{https://code-loom.com}{Code Loom (2023)}}
    \begin{flushleft}
    A website that uses OpenAI's generative capabilities to generate clear and comprehensive code documentation across various programming languages. Link: \href{https://code-loom.com}{https://code-loom.com}
    \end{flushleft}
